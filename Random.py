...
def solve_labyrinth(input_file):
    ...
    with Image.open(input_file) as img:
        ...
        for i in range(repeat):
            ...
            while stack:
                ...
                if current == end:
                    break
                neighbors_list = neighbors(current, pixels, width, height)
...
if __name__ == '__main__':
    ...
    output_file = "Random/output"
    output_file_step = "Random/step"
    solve_labyrinth(input_file)